...
GkFlacSink::GkFlacSink(QPointer<GekkoFyre::GkLevelDb> database, QPointer<QAudioOutput> audioOutput, QPointer<QAudioInput> audioInput,
 ...
 */
qint64 GkFlacSink::readData(char *data, qint64 maxlen)
{
    return 0;
}
