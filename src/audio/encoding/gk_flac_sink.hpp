...
class GkFlacSink : public QIODevice {
    Q_OBJECT

public:
    explicit GkFlacSink(QPointer<GekkoFyre::GkLevelDb> database, QPointer<QAudioOutput> audioOutput, QPointer<QAudioInput> audioInput,
