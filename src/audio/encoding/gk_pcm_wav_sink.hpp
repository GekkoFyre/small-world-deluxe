...
class GkPcmWavSink : public QIODevice {
    Q_OBJECT

public:
    explicit GkPcmWavSink(QPointer<GekkoFyre::GkLevelDb> database, QPointer<QAudioOutput> audioOutput, QPointer<QAudioInput> audioInput,
