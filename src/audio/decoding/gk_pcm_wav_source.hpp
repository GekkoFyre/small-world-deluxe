...
class GkPcmWavSource : public QIODevice {
    Q_OBJECT

public:
    explicit GkPcmWavSource(const QString &fileLoc, const quint32 &maxAmplitude, const QAudioFormat &format,
                        QPointer<GekkoFyre::GkEventLogger> eventLogger, QObject *parent = nullptr);
    ~GkPcmWavSource() override;
