...
class GkOggOpusSource : public QIODevice {
    Q_OBJECT

public:
    explicit GkOggOpusSource(const QString &fileLoc, const quint32 &maxAmplitude, const QAudioFormat &format,
                        QPointer<GekkoFyre::GkEventLogger> eventLogger, QObject *parent = nullptr);
    ~GkOggOpusSource() override;
