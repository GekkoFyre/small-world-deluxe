...
class GkXmppRosterBlockedTableViewModel : public QAbstractTableModel {
    Q_OBJECT

public:
    explicit GkXmppRosterBlockedTableViewModel(QPointer<QTableView> tableView, QWidget *parent = nullptr);
...
public slots:
    void insertData(const GekkoFyre::Network::GkXmpp::GkBlockedTableViewModel &data);
    void removeData(const GekkoFyre::Network::GkXmpp::GkBlockedTableViewModel &data);
