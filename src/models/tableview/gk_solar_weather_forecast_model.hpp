...
class GkSolarWeatherForeModel : public QAbstractTableModel {
    Q_OBJECT

public:
    explicit GkSolarWeatherForeModel(QPointer<QTableView> tableView, QPointer<GekkoFyre::GkXmppClient> xmppClient, QWidget *parent = nullptr);
    ~GkSolarWeatherForeModel() override;
