...
/**
 * @brief GkXmppRosterTableViewModel::GkXmppRosterTableViewModel
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @param database
 * @param parent
 */
GkXmppRosterTableViewModel::GkXmppRosterTableViewModel(QPointer<GkLevelDb> database, QWidget *parent)
 ...
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 */
GkXmppRosterTableViewModel::~GkXmppRosterTableViewModel()
{
    //
...
/**
 * @brief GkXmppRosterTableViewModel::populateData
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @param event_logs
 */
void GkXmppRosterTableViewModel::populateData(const QList<GkEventLogging> &event_logs)
{
    dataBatchMutex.lock();
...
/**
 * @brief GkXmppRosterTableViewModel::insertData
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @param event
 */
void GkXmppRosterTableViewModel::insertData(const GkEventLogging &event)
{
    dataBatchMutex.lock();
...
/**
 * @brief GkXmppRosterTableViewModel::removeData
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @param event
 */
void GkXmppRosterTableViewModel::removeData(const GkEventLogging &event)
{
    dataBatchMutex.lock();
...
/**
 * @brief GkXmppRosterTableViewModel::rowCount
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @param parent
 * @return
 */
int GkXmppRosterTableViewModel::rowCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);
...
/**
 * @brief GkXmppRosterTableViewModel::columnCount
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @param parent
 * @return
 */
int GkXmppRosterTableViewModel::columnCount(const QModelIndex &parent) const
{
    Q_UNUSED(parent);

    return GK_EVENTLOG_TABLEVIEW_MODEL_TOTAL_IDX; // Make sure to add the total of columns from within `GkXmppRosterTableViewModel::headerData()`!
}

/**
 * @brief GkXmppRosterTableViewModel::data
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @param index
 * @param role
 * @return
 */
QVariant GkXmppRosterTableViewModel::data(const QModelIndex &index, int role) const
{
...
/**
 * @brief GkXmppRosterTableViewModel::headerData
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @param section
 * @param orientation
 * @param role
 * @return
 */
QVariant GkXmppRosterTableViewModel::headerData(int section, Qt::Orientation orientation, int role) const
{
...
/**
 * @brief GkXmppRosterTableViewModel::determineSeverity
 * @author Phobos A. D'thorga <phobos.gekko@gekkofyre.io>
 * @return
 */
QString GkXmppRosterTableViewModel::determineSeverity() const
{
    QPointer<GkXmppRosterTableViewModel> model = new GkXmppRosterTableViewModel(gkDb);
