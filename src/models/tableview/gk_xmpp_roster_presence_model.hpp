...
public:
    explicit GkXmppRosterPresenceTableViewModel(QPointer<QTableView> tableView, QWidget *parent = nullptr);
...
public slots:
    ...
    void removeData(const GekkoFyre::Network::GkXmpp::GkPresenceTableViewModel &data);
