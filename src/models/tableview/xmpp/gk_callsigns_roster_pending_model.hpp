...
class GkCallsignsRosterPendingModel : public QAbstractTableModel {
    Q_OBJECT

public:
    explicit GkCallsignsRosterPendingModel(QWidget *parent = nullptr);
    ~GkCallsignsRosterPendingModel() override;
...
public slots:
    void insertData(const QString &bareJid, const QXmppPresence &presence);
    void removeData(const QString &bareJid);

private:
    QList<GekkoFyre::Network::GkXmpp::GkXmppPendingCallsign> m_data;
